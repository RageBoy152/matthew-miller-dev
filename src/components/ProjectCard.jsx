      ...
      <div className="flex flex-col uppercase font-space-mono">
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-4 text-xl md:text-2xl text-gray">
            {project.github && <a className="transition-colors hover:text-accent" target="_blank" href={project.github}><Github /></a>}
            {project.preview && <a className="transition-colors hover:text-accent" target="_blank" href={project.preview}><SquareArrowOutUpRight /></a>}
          </div>
        </div>
